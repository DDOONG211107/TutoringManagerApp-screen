      ...
      <View style={{ flex: 1, alignItems: 'center' }}>
        ...
        >
          ...
          <View style={{ flex: 4, flexDirection: 'column' }}>
            ...
            >
              <Text
                style={{ fontSize: 20, fontWeight: '500', marginVertical: 3 }}
              >
                {studentName} 학생
              </Text>
            ...
            <View
              style={{ flex: 1, justifyContent: 'center', paddingRight: 10 }}
            >
              <Button
                mode='contained'
        ...
        >
          <View style={{ padding: 10 }}>
            ...
            <View style={{ flexDirection: 'row', marginBottom: 7 }}>
              ...
              <Text style={{ flex: 5, fontSize: 20 }}>
                월 {studentMatchingInfo?.money / 10000}만원
              </Text>
            </View>
            <View style={{ flexDirection: 'row', marginBottom: 7 }}>
              <Text
            ...
            >
              <Text style={{ flex: 5, fontSize: 18 }}>
                ...
                어쩌구저쩌구 어쩌구저쩌구 어쩌구저쩌구 어쩌구저쩌구 어쩌구저쩌구
                어쩌구저쩌구 어쩌구저쩌구 어쩌구저쩌구 어쩌구저쩌구 어쩌구저쩌구
                어쩌구저쩌구 어쩌구저쩌구어쩌구저쩌구 어쩌구저쩌구 어쩌구저쩌구{' '}
              </Text>
            </View>
          </View>
        </Surface>
